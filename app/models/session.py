...
class EditorialSession(BaseModel):
    ...
    grill_mode: bool = Field(default=False, description="Si la sesión activó el modo de entrevista intensiva (Grill My Argument)")
    grill_questions: list[str] = Field(default_factory=list, description="Preguntas adversariales del modo Grill")
    grill_answers: list[str] = Field(default_factory=list, description="Respuestas del usuario a las preguntas del modo Grill")
